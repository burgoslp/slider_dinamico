...
<head>
    ...
    <title>Panel de control para el slider dinamico</title>
    ...
    <div class="row pt-3">
            <div class="col-12 mb-3">
                <ul class="nav nav-tabs justify-content-between align-items-center">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{url('Admin/')}}">slider</a>
                    </li>
                    ...
                    <div class="d-flex">
                        ...
                        <li class="nav-item">
                            <a href="" data-toggle="modal" data-target="#modalCreateslider">
